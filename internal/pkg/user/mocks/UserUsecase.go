...
// GetRating provides a mock function with given fields: userFrom, userTo
func (_m *UserUsecase) GetRating(userFrom int64, userTo int64) (*models.RatingStat, error) {
	ret := _m.Called(userFrom, userTo)

	var r0 *models.RatingStat
	if rf, ok := ret.Get(0).(func(int64, int64) *models.RatingStat); ok {
		r0 = rf(userFrom, userTo)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.RatingStat)
		}
	}
...
// SetRating provides a mock function with given fields: rating
func (_m *UserUsecase) SetRating(rating *models.Rating) error {
