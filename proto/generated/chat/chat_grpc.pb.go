...
func (c *chatClient) GetHistory(ctx context.Context, in *GetHistoryArg, opts ...grpc.CallOption) (*Messages, error) {
	out := new(Messages)
	err := c.cc.Invoke(ctx, "/chat.Chat/GetHistory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatClient) Create(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
...
func (c *chatClient) GetDialogs(ctx context.Context, in *UserIdentifier, opts ...grpc.CallOption) (*Dialogs, error) {
	out := new(Dialogs)
	err := c.cc.Invoke(ctx, "/chat.Chat/GetDialogs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedChatServer) GetHistory(context.Context, *GetHistoryArg) (*Messages, error) {
...
func (UnimplementedChatServer) GetDialogs(context.Context, *UserIdentifier) (*Dialogs, error) {
...
func _Chat_GetHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.Chat/GetHistory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).GetHistory(ctx, req.(*GetHistoryArg))
	}
...
func _Chat_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).Create(ctx, req.(*Message))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Chat_Clear_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(ChatServer).Clear(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.Chat/Clear",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).Clear(ctx, req.(*DialogIdentifier))
	}
	return interceptor(ctx, in, info, handler)
}

func _Chat_GetDialogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserIdentifier)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServer).GetDialogs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.Chat/GetDialogs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).GetDialogs(ctx, req.(*UserIdentifier))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Chat_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Clear",
			Handler:    _Chat_Clear_Handler,
		},
		{
			MethodName: "GetDialogs",
			Handler:    _Chat_GetDialogs_Handler,
		},
	},
